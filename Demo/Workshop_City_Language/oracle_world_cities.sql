...
-- Based on Oracle https://dev.mysql.com/doc/world-setup/en/world-setup-installation.html

-- After creating and populating the tables, you should have the following numbers of records:
-- country table:          239 records
-- countrylanguage table:  984 records
-- city table:            4079 records
...
) AUTO_INCREMENT=4080  CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
-- INSERT queries for countrylanguage table
...
-- INSERT queries for the cities on file
-- ORDER BY:  'ID'
